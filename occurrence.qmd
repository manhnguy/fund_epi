...
**Mortality rates** (or death rates) are a measure of the incidence risk of dying during a defined period of time.

**Attack rates** is a special kind of incidence risk. It is used in the context of outbreaks or epidemics of infectious diseases. It is the number of new cases occurring in the duration of the outbreak divided by the population at risk in the start of the outbreak.
...
$$\text{Incidence risk over 10 years period} = \frac{3}{25}\text{per person-year}$$
**Example 2:**
