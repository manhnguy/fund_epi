...
- all patients who fullfil the case definition who attend a specific hospital within a specified time period
...
Note: all of these data sources have some limitations, one source is unlikely to provide a complete accurate information.
...
- An individually matched design requires a matched analysis, and the odds ratio is calculated differently using ‘discordant pairs’. 
