...
*Selection bias*  may occur as we can not have 100 individuals participate in our study
...
We must be aware of all potential confounders and collect data on these confounders at the start of the study. In analysing step, check for the evidence of confounding following the 3 steps. 
...
Data on exposure and outcome are collected at the same time. It can be difficult to tell whether outcome really occur after or before exposure. if it occurs before the exposure we call *reverse causality*. We can only be sure that the expore occurred before the outcome if it is fixed characteristic of the individual(e.g. gender, age, blood group....).
